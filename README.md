...
> На экзамене присутствует внешняя комиссия. Используйте на свой страх и риск. Обязательно изучите код перед использованием — вы должны понимать каждую настройку и уметь объяснить её вручную.
